    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.flexOne}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View>
          ...
          <Text style={styles.secondaryText}>Take Coordinate of the Facility (Required)</Text>
          ...
          <Text style={styles.title}>Pictures</Text>
            <Text style={styles.secondaryText}>Take Pictures of the Facility (min 3, max 6)</Text>
          ...
          {errors.find((e) => e.path.includes('pictures')) && (
            <Text style={styles.errorText}>{errors.find((e) => e.path.includes('pictures'))?.message}</Text>
          )}
        </View>
