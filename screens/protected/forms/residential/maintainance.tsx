...
const maintenanceSchema = z.object({
  ablutionArea: z.boolean(),
  toiletFacilities: z.boolean(),
  parkingSpace: z.boolean(),
  womensAblutionArea: z.boolean(),
  womensPrayerArea: z.boolean(),
  // madrasah: z.boolean(),
  // library: z.boolean(),
  // wheelchairAccessible: z.boolean(),
  // rampsElevators: z.boolean(),
...
const Maintenance = ({ navigation }: any) => {
  const [maintenanceData, setMaintenanceData] = useState({
    ...
    womensAblutionArea: false,
    // madrasah: false,
    // library: false,
    // wheelchairAccessible: false,
    // rampsElevators: false,
  ...
  const { mosque, updateMosque } = useMosqueStore();
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.flexOne}>
        <ScrollView contentContainerStyle={styles.scrollView}>
          <View>
            ...
            <Text>Enter maintenance and facility details of the mosque</Text>
